      ...
      <div className="container mx-auto pt-8">
                        ...
                        <div className="max-w-xs">
                          {key === "horizontalConfiguration" ? (
                            ...
                            <p className="text-gray-500 size-sm">
                              Standard Deviation of Building Height is refering
                              to the building height distrubution for the
                              building blocks.
                            </p>
                          ) : key === "windDirection" ? (
                            <p className="text-gray-500 size-sm">
                              Wind Direction is the approaching angle to the
                              urban
                            </p>
                          ) : key === "areaDensity" ? (
                            <p className="text-gray-500 size-sm">
                  ...
                  {filteredData.map((folder) => (
                    <React.Fragment key={folder["Folder Name"]}>
                      <TableRow>
                        ...
                        <TableCell className="text-xs">
                          <div>
                            {Number(folder["Std of Building Height"]).toFixed(
                              2
                            )}
                          </div>
                        </TableCell>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 flex justify-between items-center">
          <p className="text-md text-gray-600">
            Selected: {Object.values(selectedFiles).flat().length} files (Total
            size: {totalSelectedSize} MB)
          </p>
          <div className="flex items-center">
            {Number.parseFloat(totalSelectedSize) > 1024 && (
              <p className="text-red-500 mr-4 text-sm">
                Please download files smaller than 1GB (1024MB) at a time to
                avoid failure.
              </p>
            )}
            <Button
